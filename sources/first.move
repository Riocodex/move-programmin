module 0x42::SocialNetwork {
    ...
    // the following are jjust modifiers for structs
    //drop:means it can be deleted
    //key:means it can be indexed in the global variable
    //store: means it can be stored in the global variable
